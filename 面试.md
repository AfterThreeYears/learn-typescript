...
4. vue.nextTick解决了什么问题？
- 防止数据更新后来马上导致页面进行无效的渲染。

5. 实现Vue中eventEmit
- on，once，off，emit

6. 为什么Vue中对数组.length的操作无法同步到视图，但是通过数据的方法操作却可以
...
4. state，props context变化是否会导致rerender
...
### DOM
1. event target和currentTarget区别
